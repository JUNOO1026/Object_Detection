...
class YOLODataset(Dataset):
    ...
    def __getitem__(self, idx):
        label_path = os.path.join(self.label_dir, self.annotiations.iloc[idx, 1])
        ...
        for box in bboxes:
            ...
            for anchor_idx  in anchor_indices:
                ...
                if not anchor_taken and not has_anchor[scale_idx]:
                    ...
                    targets[scale_idx][anchor_on_scale, i, j, 0:1] = int(class_label)

                elif not anchor_taken and iou_anchors[anchor_idx] > self.ignore_iou_threshold:
                    targets[scale_idx][anchor_on_scale, i, j, 1:5] = -1
